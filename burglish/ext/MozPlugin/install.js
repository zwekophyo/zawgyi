...
var displayName         = "Burmese Input System"; // The name displayed to the user (don't include the version)
var version             = "0.1";
var name                = "mmgeeksinput"; // The leafname of the JAR file (without the .jar part)
